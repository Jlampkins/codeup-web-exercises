   ...
   $(".box").on("click",function(){
       if($(this).text()==="" && play){     /** checks to see if the board can be claimed **/
           if(move % 2 === 1) {             /** checks to see how many moves have been made **/
               $(this).html("<h2>X</h2>");  /** if move is odd an X is placed.  If even an O is placed **/
           }else {
               $(this).append("<h2>O</h2>")
           }
           move++;
    ...
    function checkForWinner() {
        ...
        var space1 = $("#board .row:nth-child(2) .box:nth-child(1)").text();
        var space2 = $("#board .row:nth-child(2) .box:nth-child(2)").text();
        var space3 = $("#board .row:nth-child(2) .box:nth-child(3)").text();
        var space4 = $("#board .row:nth-child(3) .box:nth-child(1)").text();
        var space5 = $("#board .row:nth-child(3) .box:nth-child(2)").text();
        var space6 = $("#board .row:nth-child(3) .box:nth-child(3)").text();
        var space7 = $("#board .row:nth-child(4) .box:nth-child(1)").text();
        var space8 = $("#board .row:nth-child(4) .box:nth-child(2)").text();
        var space9 = $("#board .row:nth-child(4) .box:nth-child(3)").text();
